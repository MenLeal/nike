...
abstract class BaseCompraPeer
{
    ...
    const IDPRODUCTO = 'compra.idproducto';

    /** the column name for the estatus field */
    const ESTATUS = 'compra.estatus';
    ...
    const ESTATUS_COMPRADO = 'Comprado';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdCompra', 'IdUsuario', 'IdProducto', 'Estatus', 'Fecha', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCompra', 'idUsuario', 'idProducto', 'estatus', 'fecha', ),
        BasePeer::TYPE_COLNAME => array (CompraPeer::ID, CompraPeer::IDUSUARIO, CompraPeer::IDPRODUCTO, CompraPeer::ESTATUS, CompraPeer::FECHA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IDUSUARIO', 'IDPRODUCTO', 'ESTATUS', 'FECHA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'idusuario', 'idproducto', 'estatus', 'fecha', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdCompra' => 0, 'IdUsuario' => 1, 'IdProducto' => 2, 'Estatus' => 3, 'Fecha' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCompra' => 0, 'idUsuario' => 1, 'idProducto' => 2, 'estatus' => 3, 'fecha' => 4, ),
        BasePeer::TYPE_COLNAME => array (CompraPeer::ID => 0, CompraPeer::IDUSUARIO => 1, CompraPeer::IDPRODUCTO => 2, CompraPeer::ESTATUS => 3, CompraPeer::FECHA => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IDUSUARIO' => 1, 'IDPRODUCTO' => 2, 'ESTATUS' => 3, 'FECHA' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'idusuario' => 1, 'idproducto' => 2, 'estatus' => 3, 'fecha' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
        CompraPeer::ESTATUS => array(
            CompraPeer::ESTATUS_PENDIENTE,
            CompraPeer::ESTATUS_COMPRADO,
        ),
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CompraPeer::ID);
            $criteria->addSelectColumn(CompraPeer::IDUSUARIO);
            $criteria->addSelectColumn(CompraPeer::IDPRODUCTO);
            $criteria->addSelectColumn(CompraPeer::ESTATUS);
            $criteria->addSelectColumn(CompraPeer::FECHA);
        } else {
    ...
    {
        return CompraPeer::getSqlValueForEnum(CompraPeer::ESTATUS, $enumVal);
    }
    ...
    public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CompraPeer::IDUSUARIO, UsuarioPeer::ID, $join_behavior);
    ...
    public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CompraPeer::IDPRODUCTO, ProductoPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Compra objects pre-filled with their Producto objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Compra objects.
    ...
    public static function doSelectJoinProducto(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Compra) to $obj2 (Producto)
                $obj2->addCompra($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Compra) to the collection in $obj3 (Producto)
                $obj3->addCompra($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Compra objects pre-filled with all related objects except Usuario.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CompraPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Compra) to the collection in $obj2 (Producto)
                $obj2->addCompra($obj1);
    ...
    /**
     * Selects a collection of Compra objects pre-filled with all related objects except Producto.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CompraPeer::ID) && $criteria->keyContainsValue(CompraPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.CompraPeer::ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CompraPeer::ID);
            $value = $criteria->remove(CompraPeer::ID);
            if ($value) {
                $selectCriteria->add(CompraPeer::ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CompraPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(CompraPeer::FECHA))
            $columns[CompraPeer::FECHA] = $obj->getFecha();
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CompraPeer::DATABASE_NAME);
            $criteria->add(CompraPeer::ID, $pks, Criteria::IN);
