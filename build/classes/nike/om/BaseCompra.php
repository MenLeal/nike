...
abstract class BaseCompra extends BaseObject implements Persistent
{
    ...
    public function getEstatus()
    {
        ...
        $valueSet = CompraPeer::getValueSet(CompraPeer::ESTATUS);
    ...
    public function setIdProducto($v)
    {
        ...
        if ($this->idproducto !== $v) {
            $this->idproducto = $v;
            $this->modifiedColumns[] = CompraPeer::IDPRODUCTO;
        }
    ...
    public function setEstatus($v)
    {
        ...
        if ($this->estatus !== $v) {
            $this->estatus = $v;
            $this->modifiedColumns[] = CompraPeer::ESTATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->estatus = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 5; // 5 = CompraPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompraPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CompraPeer::IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`idusuario`';
        }
        if ($this->isColumnModified(CompraPeer::IDPRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = '`idproducto`';
        }
        if ($this->isColumnModified(CompraPeer::ESTATUS)) {
            $modifiedColumns[':p' . $index++]  = '`estatus`';
        }
        if ($this->isColumnModified(CompraPeer::FECHA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompraPeer::IDPRODUCTO)) $criteria->add(CompraPeer::IDPRODUCTO, $this->idproducto);
        if ($this->isColumnModified(CompraPeer::ESTATUS)) $criteria->add(CompraPeer::ESTATUS, $this->estatus);
     ...
     * @return PropelObjectCollection|Envio[] List of Envio objects
     */
    public function getEnviosJoinDireccion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EnvioQuery::create(null, $criteria);
        $query->joinWith('Direccion', $join_behavior);
