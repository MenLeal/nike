...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->apellidop = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->apellidom = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setApellidoPaterno($arr[$keys[2]]);
    ...
    public function clearDireccions()
    {
        ...
        $this->collDireccionsPartial = null;
        ...
        if (null === $this->collDireccions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDireccions) {
                ...
                if (null !== $criteria) {
                    ...
                    $collDireccions->getInternalIterator()->rewind();
    ...
    public function setDireccions(PropelCollection $direccions, PropelPDO $con = null)
    {
        ...
        foreach ($direccionsToDelete as $direccionRemoved) {
            $direccionRemoved->setUsuario(null);
        }
    ...
    public function addDireccion(Direccion $l)
    {
        ...
        if (!in_array($l, $this->collDireccions->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    public function setFavoritoss(PropelCollection $favoritoss, PropelPDO $con = null)
    {
        ...
        foreach ($favoritossToDelete as $favoritosRemoved) {
            $favoritosRemoved->setUsuario(null);
        }
     ...
     * @return PropelObjectCollection|Favoritos[] List of Favoritos objects
     */
    public function getFavoritossJoinProducto($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FavoritosQuery::create(null, $criteria);
