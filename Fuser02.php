...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
            switch ($seccion)
            {
                case "listar_producto": include_once 'paginas/productos/listar.php';
                    break;
                case "agregar_producto": include_once 'paginas/productos/agregar.php';
                break;
                default: include_once 'paginas/productos/inicio.php';
                    break;
            }
      ?>     
    </div>
