...
switch ($fil){
    case 'H':
        $productos = ProductoQuery::create()->findByGenero($fil);
    break;
    case 'M':
        $productos = ProductoQuery::create()->findByGenero($fil);
    break;
    ...
    case 'Negro':
        $productos = ProductoQuery::create()->findByColor($fil);
    break;
    case 'Blanco':
        $productos = ProductoQuery::create()->findByColor($fil);
    break;
    ...
    case 'Street':
        $productos = ProductoQuery::create()->findByEstilo($fil);
    break;
    case 'Soccer':
        $productos = ProductoQuery::create()->findByEstilo($fil);
    break;
...
<body>
  <div class="container-fluid" style="background-color:#000;">
    ...
    <div class="row">
      <div class="col-12 d-none d-md-block">
        <nav class="navbar  bg-info navbar-dark fixed-top">
          ...
          <a class="nav-brand" href="fuser02.php">
            <img src="img/usuario.png" class="rounded-circle bg-light" height="80px" width="80px">
          </a>
        </nav>
      </div>
    </div>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner text-center">
        <div class="carousel-item active">
          <img src="img/nike1.jpg" height="500px" width="1200px" alt="1">
        ...
        <div class="carousel-item">
          <img src="img/nike6.jpg" height="500px" width="1200px" alt="2">
        </div>
        <div class="carousel-item">
          <img src="img/nike2.png" height="500px" width="1200px" alt="disculpa">
        </div>
        <div class="carousel-item">
          <img src="img/nike3.jpg" height="500px" width="1200px" alt="disculpa">
        </div>
        <div class="carousel-item">
          <img src="img/nike4.jpg" height="500px" width="1200px" alt="disculpa">
        </div>
      </div>
    ...
    <div class="row bg-white">
      <a class="btn btn-danger" role="button" href="index.php">
        Eliminar Filtro <img src="img/x.png" width="30" height="30" style="vertical-align: middle">
      </a>
    </div>
    <!-- Fin Categorias -->
